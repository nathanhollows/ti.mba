...
(function ($) {
    ...
    */      
    ...
    '<div class="control-group d-flex flex-column align-items-start">' + 
    '<div class="d-flex"><div class="editable-input mr-2"></div><div class="editable-buttons"></div></div>'+
    '<small class="editable-error-block text-danger"></small>' + 
    '</div>' + 
    '</form>';
...
(function ($) {
    ...
    $.fn.editableform.buttons = 
      '<button type="submit" class="btn btn-primary btn-sm editable-btn editable-submit mr-1">'+
        '<img src="/img/icons/check.svg" class="feather" aria-hidden="true">'+
      '</button>'+
      '<button type="button" class="btn btn-secondary btn-sm editable-btn editable-cancel">'+
        '<img src="/img/icons/x.svg" class="feather" aria-hidden="true">'+
      '</button>';         
...
(function ($) {
    ...
    DateField.defaults = $.extend({}, $.fn.editabletypes.date.defaults, {
        ...
        @property tpl
        **/
        tpl:'<div class="input-append date"><input type="date" class="form-control"/><span class="add-on"></span></div>',
        /**
        @property inputclass
        @default 'input-small'
        **/
