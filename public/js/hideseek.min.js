 ...
 */
!function(u,t){"use strict";u.fn.hideseek=function(i){i=u.extend({list:".hideseek-data",nodata:"",attribute:"text",matches:!1,highlight:!1,ignore:"",headers:"",navigation:!1,ignore_accents:!1,hidden_mode:!1,min_chars:1,throttle:0,wildcards:!1},i);return this.each(function(){var c=u(this);c.opts=[],c.state={},u.map(["list","nodata","attribute","matches","highlight","ignore","headers","navigation","ignore_accents","hidden_mode","min_chars","throttle","wildcards"],function(e,t){c.opts[e]=c.data(e)||i[e]}),c.opts.headers&&(c.opts.ignore+=c.opts.ignore?", "+c.opts.headers:c.opts.headers);var p=function(e){return e=e.toLowerCase(),c.opts.ignore_accents?t.removeAccents(e):e},g=u(c.opts.list);c.opts.navigation&&c.attr("autocomplete","off"),c.opts.hidden_mode&&g.children().hide(),c.keyup(function(t,i){if(!i||"number"!=typeof i||i<=0)return t;var s=0;return function(){var e=arguments;clearTimeout(s),s=setTimeout(function(){t.apply(null,e)},i)}}(function(e){var t,i,s,n,a=p(c.val());if(c.opts.min_chars&&a.length<c.opts.min_chars&&(a=""),i=a,(t=c).state.lastQuery!=i&&(t.state.lastQuery=i,1)){var r=function(e){return-1!=e.indexOf(a)};if(c.opts.wildcards&&-1!==a.indexOf("*")&&1<a.length){var o=("*"==a[0]?"":"\\b")+a.replace(/[.+?^${}()|[\]\\]/g,"\\$&").replace(/\*/g,"\\w*")+("*"==a[a.length-1]?"":"\\b"),h=new RegExp(o);r=function(e){return h.test(e)}}g.children(c.opts.ignore.trim()?":not("+c.opts.ignore+")":"").removeClass("selected").each(function(){var e=p("text"!=c.opts.attribute?u(this).attr(c.opts.attribute)||"":u(this).text());!r(e)||a===(!!c.opts.hidden_mode&&"")?u(this).hide():c.opts.matches&&null!==a.match(new RegExp(Object.keys(c.opts.matches)[0]))?null!==e.match(new RegExp(Object.values(c.opts.matches)[0]))?l(u(this)):u(this).hide():l(u(this)),c.trigger("_after_each")}),c.opts.nodata&&(g.find(".no-results").remove(),g.children(':not([style*="display: none"])').length||(g.children().first().clone().removeHighlight().addClass("no-results").show().prependTo(c.opts.list).text(c.opts.nodata),c.trigger("_after_nodata"))),c.opts.headers&&u(c.opts.headers,g).each(function(){u(this).nextUntil(c.opts.headers).not('[style*="display: none"],'+c.opts.ignore).length?u(this).show():u(this).hide()}),c.trigger("_after")}function l(e){c.opts.highlight?e.removeHighlight().highlight(a,c.opts.ignore_accents).show():e.show()}function d(e){return e.children(".selected:visible")}c.opts.navigation&&(38==e.keyCode?d(g).length?((n=g,d(n).prevAll(":visible:first")).addClass("selected"),d(g).last().removeClass("selected")):g.children(":visible").last().addClass("selected"):40==e.keyCode?d(g).length?((s=g,d(s).nextAll(":visible:first")).addClass("selected"),d(g).first().removeClass("selected")):g.children(":visible").first().addClass("selected"):13==e.keyCode&&(d(g).find("a").length?document.location=d(g).find("a").attr("href"):c.val(d(g).text())))},c.opts.throttle))})},u(document).ready(function(){u('[data-toggle="hideseek"]').hideseek()})}(jQuery,window.hideseek=window.hideseek||{}),
/**
 * highlight v4
 *
